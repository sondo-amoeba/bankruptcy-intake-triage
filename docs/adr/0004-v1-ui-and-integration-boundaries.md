...
**Considered:** Single-page only with hidden case IDs — rejected (hard to demo audit/export); full ops queue with filters — rejected (CMS creep); real PM webhook — deferred to a future release.

**Consequences:** Sample intakes create or open persisted cases. README documents v1 scope cuts; real external integrations remain out of scope for v1.
